...
class weightlossact extends StatefulWidget {
  final day;
  final check;

  weightlossact(this.day, this.check);
  @override
  _weightlossactState createState() => _weightlossactState();
}

class _weightlossactState extends State<weightlossact> {
  @override
            ...
            children: [
              ...
              Expanded(
                  ...
                  child: ListView.builder(
                      itemCount: weightlosswk[widget.day%2].length,
                      itemBuilder: (contex,index){

                        return Card(
                          child: Row(
                            children: [
                              Image.asset(weightlosswk[widget.day%2][index].gif,
                                width: 100.0,
                                height: 100.0,
                              ...
                              SizedBox(width: 20.0,),
                              Text(weightlosswk[widget.day%2][index].wname)
                            ],
                          ),
                        );
              ...
              Center(
                  child: widget.check == 'c'
                    ...
                    color: Colors.blue,
                    child: Text('please complete above firs'),
